...
**Actualised link: http://www.xmind.net/m/G3nsU3**
...
| Measure of association | Precision | No effect  | Negligible effect | Small effect | Medium effect | Large effect |
  |:------------------:|:-------------:|:----------------:|:----------------------:|:----------------------:|:----------------------:|:----------------------:|
  | Cohen's *h* | ø | *h* = 0 | *h* < 0.2 | 0.2 ≥ *h* < 0.5 |0.5 ≥ *h* < 0.8 | *h* ≥ 0.8 |
| Phi coefficient | ø | *φ* = 0 | *φ* < 0.1 | 0.1 ≥ *φ* < 0.3 | 0.3 ≥ *φ* < 0.5 | *φ* ≥ 0.5 |
...
| Cohen's *g* | ø | *g* = 0 | *g* < 0.05 | 0.05 ≥ *g* < 0.15 | 0.15 ≥ *g* < 0.25 | *g* ≥ 0.25 |
...
|DRC.linearOrigin | Straight line through origin | ![Y = b_1 \, X](https://render.githubusercontent.com/render/math?math=Y%20%3D%20b_1%20%5C%2C%20X%20%5Cquad%20%5Cquad%20%5Cquad) |
...
The package "drc" already provides methods to calculate the confidence interval around the non-linear models created with its Self-Starters (*predict.drc*). However, this feature is not available for the model created from "aomisc" self-starters, though some of them are often the best models (e.g. linear, exponential, logarithmic). In addition, the *predict.drc* function only works with 72 Self-Starters, according to my own tests (**see the Appendix at the end for the list**).
